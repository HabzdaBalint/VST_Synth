...
struct AdditiveSynthParameters : juce::AudioProcessorValueTreeState::Listener
{
    ...
    /*
    juce::AudioProcessorParameterGroup *OscillatorGroup = nullptr;
    juce::AudioProcessorParameterGroup *SynthesizerGroup = nullptr;
    */
    ...
    void createParameterLayout(juce::AudioProcessorValueTreeState::ParameterLayout &layout)
    {
        ...
        //std::vector<std::unique_ptr<juce::AudioProcessorParameterGroup>> vector2;
        ...
        /*
        SynthesizerGroup = new juce::AudioProcessorParameterGroup();
        SynthesizerGroup->addChild(std::make_unique<juce::AudioParameterFloat>("synthGain1",
                                                  "Gain",
                                                  juce::NormalisableRange<float>(-90.f, 0.f, 0.1), -12.f));

        vector2.emplace_back(SynthesizerGroup);
        */
